...
logo=("""\n
      ...
      __            __       ___  ___  ____  ____   ________  __    __  
        _     _   __ __  _ _   __   _    ____________
                                                                                                          
                                                                                                  
      db                                   db          `YMM'    `MM'     `7MMF'  M.        M" " "bgd.            7MMF.              7MMF
     ;MM:                             ;MM:           VMA    ,V           MM        M.       MI.                           MM.                 MM
    ,V^MM.                        ,V^MM.           VMA  ,V           MM       M.        MMB                      MM.                 MM
   ,M  `MM                       ,M  `MM            VMMP           MM       M.                 YMMq.         MMmmmmmMM
   AbmmmqMA.        AbmmmqMA            MM           MM       M.        .               MM       MM.                   MM
  A'     VML        A'     VML           MM           YM.            Mb     dM.                         DD.       MM.                   MM
.AMA.   .AMMA.    .AMA.   .AMMA.       .JMML.       `bmmmmd"'         p"ybmmd.      JMMJ.              JMMJ
